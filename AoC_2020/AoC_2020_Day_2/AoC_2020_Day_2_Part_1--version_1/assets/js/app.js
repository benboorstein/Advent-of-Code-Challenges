...
function masterFunc(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        let char = arr[i][2] // did just to make easier to read below 
        let pwArr = arr[i][3].split('') // did because I need to in order to make it work in the j loop 
        let occurrences = 0
        ...
        let min = arr[i][0] // did just to make easier to read below
        let max = arr[i][1] // did just to make easier to read below
...
console.log(masterFunc(inputsArr)) // 434 // correct
// GENERALLY, MAIN ISSUE I HAD trying to convert what's below into something workable for an array of arrays instead of just one array: iterations of loops can't be returned/saved and called later.