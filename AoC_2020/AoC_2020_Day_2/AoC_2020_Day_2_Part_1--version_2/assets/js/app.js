// Note that, for this AoC challenge (Day 2, Part 1), this version (version 2) is truer to the intent of AoC than version 1 because of the way the array is set up and its information accessed.
...
function masterFunc(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        let char = inputsArr[i].split(' ')[1][0] // e.g., 'h' in the array's final string
        let pw = inputsArr[i].split(' ')[2] // e.g., 'hlhhhhrdjncphc' in the array's final string
        let occurrences = 0
        ...
        let [min, max] = inputsArr[i].split(' ')[0].split('-') // e.g., '6' and '8' in the array's final string
